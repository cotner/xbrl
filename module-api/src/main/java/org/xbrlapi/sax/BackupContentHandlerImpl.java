 ...
 */
public class BackupContentHandlerImpl extends BaseContentHandlerImpl implements ContentHandler {
     ...
     * are null.
     */
	public BackupContentHandlerImpl(Loader loader, URL url) throws XBRLException {
		super(loader, url);		
     ...
     * are null.
     */
	public BackupContentHandlerImpl(Loader loader, URL url, String xml) throws XBRLException {
		this(loader, url);
		setXML(xml);
	}	
