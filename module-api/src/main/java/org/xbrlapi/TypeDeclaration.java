...
public interface TypeDeclaration extends SchemaDeclaration {
    ...
    /**
     * @param namespace The namespace of the prospective type.
     * @param name The local name of the prospective type.
     * @return true if this type declaration is or is derived from the specified type declaration.
