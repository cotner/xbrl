 ...
 */
public class CachingLabellerImpl extends LabellerImpl implements Labeller {
    ...
    .getLogger(CachingLabellerImpl.class);
     ...
     */
    public CachingLabellerImpl(LabelCache cache, Labeller labeller) throws XBRLException {
        super();
