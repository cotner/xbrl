...
public class ArcTestCase extends DOMLoadingTestCase {
	...
	public void testGetTo() {	
		...
		try {
			List<Arc> fragments = store.<Arc>queryForFragments("#roots#/*/*[@xlink:type='arc']");
	...
	public void testGetFrom() {	
		...
		try {
			List<Arc> fragments = store.<Arc>queryForFragments("#roots#/" + Constants.XBRLAPIPrefix + ":" + "data/*[@xlink:type='arc']");
			Arc fragment = fragments.get(0);
