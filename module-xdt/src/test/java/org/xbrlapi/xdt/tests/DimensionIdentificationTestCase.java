...
public class DimensionIdentificationTestCase extends BaseTestCase {
	...
	public void testExplicitDimensionIdentification() {
		...
		try {
			...
			List<ExplicitDimension> fragments = store.<ExplicitDimension>getFragments("org.xbrlapi.xdt.ExplicitDimensionImpl");
    ...
    public void testTypedDimensionIdentification() {
        ...
        try {
            ...
            List<TypedDimension> fragments = store.<TypedDimension>getFragments("org.xbrlapi.xdt.TypedDimensionImpl");
            assertTrue(fragments.size() > 0);
